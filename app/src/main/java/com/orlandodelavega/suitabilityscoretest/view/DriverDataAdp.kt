...
class DriverDataAdp(private val data: ArrayList<String>, private val curScreen: MainActivity) : RecyclerView.Adapter<DriverDataAdp.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        holder.btnData.setOnClickListener{
            curScreen.selectedDriverPos = position
